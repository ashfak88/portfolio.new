      ...
      <div className="container">
        ...
        <div className="glass-card" style={{ position: 'relative' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', color: 'var(--text-muted)', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <li>Developed and enhanced responsive user interfaces using React.js, JavaScript (ES6+), and Redux.</li>
            ...
            <li>Implemented authentication (JWT), CRUD operations, and scalable database design.</li>
          </ul>
        </div>
      </div>
    </section>
